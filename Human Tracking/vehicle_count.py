...
def realTime():
    while True:
        ...
        cv2.putText(img, "Person:     "+str(up_list[1])+"     "+ str(down_list[1]), (20, 60), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, font_thickness)
    ...
    with open("data.csv", 'w') as f1:
        ...
        cwriter.writerow(['Direction', 'car', 'Person', 'bus', 'truck'])
        up_list.insert(0, "Up")
...
image_file = 'vehicle classification-image03.jpg'
def from_static_image(image):
    ...
    cv2.putText(img, "Person:  "+str(frequency['person']), (20, 60), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, font_thickness)
    cv2.putText(img, "Motorcycle:        "+str(frequency['motorbike']), (20, 80), cv2.FONT_HERSHEY_SIMPLEX, font_size, font_color, font_thickness)
