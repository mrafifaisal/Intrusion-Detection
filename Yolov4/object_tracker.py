...
flags.DEFINE_string('video', './Media/VIRAT_S_010204_05_000856_000890.mp4', 'path to input video or set to 0 for webcam')
...
def main(_argv):
    ...
    while True:
        ...
        # draw bbox on screen
            ...
            cv2.rectangle(frame, (int(bbox[0]), int(bbox[1]-30)), (int(bbox[0]), int(bbox[1])), color, -1)
